    ...
    <div class="l-navbar" id="nav-bar">
        <nav class="nav">
            ...
            <div class="nav_list" v-if="user">
                ...
                <router-link class="nav_link" to="/meals" data-toggle="tooltip" data-placement="right"
                title="Meal History"><i class="bi bi-clock-history"></i></router-link>
            </div>
...
:root {
    --header-height: 3rem;
    --nav-width: 68px;
    --first-color: hsl(153, 86%, 19%);
    --first-color-light: #bdbdbd;
    --white-color: #F7F6FB;
